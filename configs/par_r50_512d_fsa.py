...
def basic_training_parameters(parser):
    ...
    parser.add_argument('--dataset',              default='online_products',   type=str,   help='Dataset to use. Currently supported: cub200, cars196, online_products, in_shop.')
    ...
    parser.add_argument('--loss',            default='multisimilarity_ca',      type=str,   help='Training criteria: For supported methods, please check criteria/__init__.py')
    ...
    parser.add_argument('--arch',             default='resnet_fsa_frozen_normalize',  type=str,   help='Underlying network architecture. Frozen denotes that \
                                                                                                  exisiting pretrained batchnorm layers are frozen, and normalize denotes normalization of the output embedding.')

    ##### add params
    parser.add_argument('--label_guide', action='store_true', default=True)
    parser.add_argument('--d_model', default=256, type=int)
    parser.add_argument('--n_head', default=8, type=int)
    parser.add_argument('--atten_layers', default=2, type=int)
    parser.add_argument('--eval_epoch_gap', default=1, type=int)
    parser.add_argument('--checkpoint_path', default="./checkpoints/fsa_r50_sop.pth.tar", type=str)
    ...
    parser.add_argument('--evaluation_metrics', nargs='+', default=['e_recall@1', 'e_recall@10', 'e_recall@100', 'e_recall@1000', 'mAP_c', \
    ...
    parser.add_argument('--source_path',  default='D:/dataset/CBIR',   type=str, help='Path to training data.')
...
def wandb_parameters(parser):
    ...
    parser.add_argument('--wandb_key',       default='8cf531c3696ee85b51f060f2a076a74468625f9b',  type=str,   help='API key for W&B.')
    parser.add_argument('--project',         default='DML_Project',       type=str,   help='Name of the project - relates to W&B project names. In --savename default setting part of the savename.')
    parser.add_argument('--group',           default='tql33tql',         type=str,   help='Name of the group - relates to W&B group names - all runs with same setup but different seeds are logged into one group. \
